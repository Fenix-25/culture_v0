            ...
            <div class="d-flex flex-wrap align-items-center justify-content-end justify-content-lg-end">
                <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small align-items-center">
                    <?php if (!$_SESSION['user']['isAdmin']): ?>
                        <li>
                        <a href="/home" class="nav-link <?= getUrl() == 'home' ? "text-secondary" : "text-white" ?>">
                    ...
                    <?php else: ?>
                        <a href="/admin" class="nav-link <?= getUrl() == 'admin' ? "text-secondary" : "text-white" ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 class="bi bi-house d-block mx-auto mb-1" viewBox="0 0 16 16">
                                <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5ZM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5 5 5Z"/>
                            </svg>
                        ...
                        <li>
                            <a href="/dashboard"
                               class="nav-link <?= getUrl() == 'dashboard' ? "text-secondary" : "text-white" ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li>
                            <a href="/orders"
                               class="nav-link <?= getUrl() == 'orders' ? "text-secondary" : "text-white" ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li>
                            <a href="/allData"
                               class="nav-link <?= getUrl() == 'allData' ? "text-secondary" : "text-white" ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li>
                        <a href="/customers"
                           class="nav-link <?= getUrl() == 'customers' ? "text-secondary" : "text-white" ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <?php if (empty($_SESSION['user'])): ?>
        <div class="px-3 py-2 border-bottom mb-3">
            <div class="container d-flex flex-wrap justify-content-end">
                <div class="text-end">
                    <?php if (getUrl() == "login" xor empty($_SESSION['user'])): ?>
                        <a href="/login" class="btn btn-light text-dark me-2">Login</a>
                    <?php endif; ?>
                    <?php if (getUrl() == "register" xor empty($_SESSION['user'])): ?>
